...
clear
cd 
echo "\033[1;93m#Earning Premium"
figlet  "Earning Premium"
echo ""
apt update
apt upgrade
echo "$(tput setaf 5) Subscribe < Earning Premium YT channel For more Termux videos "
echo ""
...
echo "|-----------------------------|"
echo "$(tput setaf 3) Subscribe Earning Premium.."
echo "|-----------------------------|"
echo ""
